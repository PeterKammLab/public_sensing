...
# Better overview by grouping lines into categories
with st.expander("Select Tram Lines"):
    tram_lines = st.multiselect(
        "Tram Lines",
        ['1', '2', '3', '4', '5', '7', '12', '13', '14', '17', '19', '24', '26']
    )

with st.expander("Select Bus Lines"):
    bus_lines = st.multiselect(
        "Bus Lines",
        ['18', '21', '22', '34', '35', '36', '37', '38', '41', '43', '44', '47', '49', 
         '61', '63', '65', '68', '231', '232', '233', '461', '463', '464', '48', '66', '267', '369', '62', '40', '245', '246', '247', '76']
    )

with st.expander("Select Night Bus Lines"):
    night_bus_lines = st.multiselect(
        "Night Bus Lines",
        ['N81', 'N82', 'N83', 'N86', 'N87', 'N88', 'N89', 'N91', 'N93', 'N85', 'N84']
    )
